...
Click to expand
    ...
    ## [10] fansi_1.0.6           pkgconfig_2.0.3       data.table_1.16.2    
    ## [13] desc_1.4.3            lifecycle_1.0.4       compiler_4.4.2       
    ...
    ## [28] stringi_1.8.4         diffobj_0.3.5         purrr_1.0.2          
    ## [31] labeling_0.4.3        rsvg_2.6.1            cowplot_1.1.3        
    ## [34] rprojroot_2.0.4       fastmap_1.2.0         grid_4.4.2           
    ## [37] colorspace_2.1-1      cli_3.6.3             magrittr_2.0.3       
    ## [40] pkgbuild_1.4.5        utf8_1.2.4            readr_2.1.5          
    ## [43] withr_3.0.2           waldo_0.6.1           ospsuite.utils_1.5.38
    ## [46] scales_1.3.0          bit64_4.5.2           rmarkdown_2.29       
    ## [49] bit_4.5.0             ggtext_0.1.2          png_0.1-8            
